...
return [
    ...
    'title' => 'GESPAT — API Documentation',

    'description' => 'API REST de la plateforme GESPAT (Gestion du Patrimoine & Inventaire). '
        .'Couvre la gestion des immobilisations, l\'inventaire physique mobile, la codification SYSCOHADA, '
        .'le rapprochement comptable et le reporting.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Récupérer un token via `POST /api/v1/auth/login` avec email + password. '
            .'Inclure ensuite l\'en-tête `Authorization: Bearer <token>` dans chaque requête.',
    ],
